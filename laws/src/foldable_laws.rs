...
mod tests {
    ...
    fn test_vec_is_empty_consistency() {
        ...
        fn vec_is_empty_consistency_prop(x: Vec<i32>) -> bool {
            vec_is_empty_consistency::<i32>(&x)
        }

        quickcheck(vec_is_empty_consistency_prop as fn(Vec<i32>) -> bool);
    }
    ...
    fn test_vec_fold_left_sum() {
        ...
        fn vec_fold_left_sum_prop(x: Vec<i8>) -> bool {
            vec_fold_left_sum(&x)
        }

        quickcheck(vec_fold_left_sum_prop as fn(Vec<i8>) -> bool);
    }
    ...
    fn test_vec_fold_right_sum() {
        ...
        fn vec_fold_right_sum_prop(x: Vec<i8>) -> bool {
            vec_fold_right_sum(&x)
        }

        quickcheck(vec_fold_right_sum_prop as fn(Vec<i8>) -> bool);
    }
    ...
    fn test_option_length_consistency() {
        fn option_length_consistency_prop(x: Option<i32>) -> bool {
            option_length_consistency::<i32>(&x)
        }
    ...
    fn test_option_is_empty_consistency() {
        fn option_is_empty_consistency_prop(x: Option<i32>) -> bool {
            option_is_empty_consistency::<i32>(&x)
        }

        quickcheck(option_is_empty_consistency_prop as fn(Option<i32>) -> bool);
    }
    ...
    fn manual_vec_all_any_tests() {
        let v = vec![2, 4, 6, 8];
        assert!(vec_all_any_duality(&v, |&x| x % 2 == 0));
        assert!(vec_all_any_duality(&v, |&x| x > 0));
        assert!(vec_all_any_duality(&v, |&x| x > 10));
    }
